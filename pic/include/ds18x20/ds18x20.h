...
extern uint8_t DS18X20_search_sensors(__near uint8_t *sensors, const uint8_t maxsensors);
extern uint8_t DS18X20_find_sensor(__near uint8_t *diff, __near uint8_t id[]);
extern uint8_t DS18X20_get_power_status(__near uint8_t id[]);
extern uint8_t DS18X20_start_meas( uint8_t with_external, __near uint8_t id[]);
...
#define DS18X20_conversion_in_progress() (( ow_bit_io( 1 ) ? DS18X20_CONVERSION_DONE : DS18X20_CONVERTING ))


#if DS18X20_DECICELSIUS
extern uint8_t DS18X20_read_decicelsius(__near  uint8_t id[], __near int16_t *decicelsius );
#define DS18X20_read_decicelsius_single(familycode, decicelsius) DS18X20_read_decicelsius(&familycode, decicelsius)
...
extern uint8_t DS18X20_read_maxres(__near uint8_t id[], __near int32_t *temperaturevalue );
#define DS18X20_read_maxres_single(familycode, temperaturevalue) DS18X20_read_maxres(&familycode, temperaturevalue )
#endif /* DS18X20_MAX_RESOLUTION */


#if DS18X20_EEPROMSUPPORT
// copy values int scratchpad into DS18x20 eeprom
uint8_t DS18X20_scratchpad_to_eeprom( uint8_t with_power_extern, __near uint8_t id[] );
