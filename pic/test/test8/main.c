...
#include <rfm73/rfm73_config.h>
#include <rfm73/rfm73.h>
#include <rfm73/rfm73.c>
...
unsigned char __near *bla1 = 0x6;
unsigned char __far *bla2 = 0x5;
unsigned char *bla3 = 0x7;
int main(void)
{
	unsigned char i;

	bla1=(unsigned char __near *)0x02;
	bla2=(unsigned char __far *)0x02;
	bla3=0x7;
