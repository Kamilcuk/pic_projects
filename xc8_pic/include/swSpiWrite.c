...
#define PORTOUT GETPORT(SW_SPI_OUT_PORT, SW_SPI_OUT_PIN)
#define TRISOUT GETTRIS(SW_SPI_OUT_PORT, SW_SPI_OUT_PIN)
#define PORTSCK GETPORT(SW_SPI_SCK_PORT, SW_SPI_SCK_PIN)
#define TRISSCK GETTRIS(SW_SPI_SCK_PORT, SW_SPI_SCK_PIN)
